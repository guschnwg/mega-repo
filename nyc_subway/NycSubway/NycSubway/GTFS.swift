...
extension TransitRealtime_TripUpdate {
    public func stopTimeUpdateFor(stopID: String) -> TransitRealtime_TripUpdate.StopTimeUpdate? {
        return self.stopTimeUpdate.first { $0.stopID == stopID } ?? nil
    }
    
    public func arrivalTimeFor(stopID: String) -> Int64? {
        return self.stopTimeUpdateFor(stopID: stopID)?.arrival.time
    }
}
